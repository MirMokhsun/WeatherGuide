...
export const styles = StyleSheet.create({
    ...
    VB1:
        { flex: 0.3},
    VB2:
        { flex: 0.3, marginTop: "12%"},
    txtInView:
        { flexDirection: 'row', borderColor: 'gray', borderWidth: 2, borderRadius: 25, height: 50, width: width / 1.5, },
    txtIn:
        { height: 50, width: "100%", fontSize: 16, paddingLeft: 50 },
    logBut:
    ...
    txt:
        { fontSize: 20, fontFamily: 'OdibeeSans-Regular'},
})